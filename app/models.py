...
class ServiceItem(models.Model):
    ...
    item_price = models.DecimalField(_('单价（元）'), null=True, decimal_places=2, max_digits=10)
    item_count = models.DecimalField(_('数量'), null=True, default=1, decimal_places=2, max_digits=10)
